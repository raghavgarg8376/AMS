...
import com.audit.repository.AuditResponseRepo;
...
class AuditResponseServiceTests {
	...
	public void testGetAuditResponseInternal3Nos() {
		...
		List<AuditQuestion> questions = new ArrayList<>();		
		questions.add(new AuditQuestion(1,"Have all Change requests followed SDLC before PROD move?","Internal","YES"));
		questions.add(new AuditQuestion(2,"Have all Change requests been approved by the application owner?","Internal","YES"));
	...
	public void testGetAuditResponseInternal4Nos() {
		...
		List<AuditQuestion> questions = new ArrayList<>();		
		questions.add(new AuditQuestion(1,"Have all Change requests followed SDLC before PROD move?","Internal","YES"));
		questions.add(new AuditQuestion(2,"Have all Change requests been approved by the application owner?","Internal","NO"));
		questions.add(new AuditQuestion(3,"Are all artifacts like CR document, Unit test cases available?","Internal","NO"));
		questions.add(new AuditQuestion(4,"Is the SIT and UAT sign-off available?","Internal","NO"));
		questions.add(new AuditQuestion(5,"Is data deletion from the system done with application owner approval?","Internal","NO"));
	...
	public void testGetAuditResponseSox1Nos() {
		...
		questions.add(new AuditQuestion(2,"Have all Change requests been approved by the application owner?","SOX","NO"));
	...
	public void testCreateAuditResponseSoxGreenStatus() {
		questions.add(new AuditQuestion(1,"Have all Change requests followed SDLC before PROD move?","SOX","YES"));
		questions.add(new AuditQuestion(2,"Have all Change requests been approved by the application owner?","SOX","YES"));
		questions.add(new AuditQuestion(3,"For a major change, was there a database backup taken before and after PROD move?","SOX","YES"));
		questions.add(new AuditQuestion(4,"Has the application owner approval obtained while adding a user to the system?","SOX","YES"));
		questions.add(new AuditQuestion(5,"Is data deletion from the system done with application owner approval?","SOX","NO"));
	...
	public void testCreateAuditResponseSoxRedStatus() {
		questions.add(new AuditQuestion(1,"Have all Change requests followed SDLC before PROD move?","SOX","YES"));
		questions.add(new AuditQuestion(2,"Have all Change requests been approved by the application owner?","SOX","YES"));
		questions.add(new AuditQuestion(3,"For a major change, was there a database backup taken before and after PROD move?","SOX","NO"));
		questions.add(new AuditQuestion(4,"Has the application owner approval obtained while adding a user to the system?","SOX","NO"));
		questions.add(new AuditQuestion(5,"Is data deletion from the system done with application owner approval?","SOX","NO"));
